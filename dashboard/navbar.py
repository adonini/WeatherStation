...
navbar_menu = dbc.DropdownMenu([
    ...
    dbc.DropdownMenuItem("ORM Weather Info", href="https://astro.ing.iac.es/weather/index.php?miniview=1", target="_blank", className="text-primary text-capitalize", external_link=True),
    ...
    dbc.DropdownMenuItem("ING Weather Info", href="https://astro.ing.iac.es/weather/", className="text-primary text-capitalize", target="_blank", external_link=True),
